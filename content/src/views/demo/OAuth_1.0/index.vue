<template>
 ...
 <div class="row" style="margin-bottom: 20px;border-bottom: 1px solid #eeeeee">
        <div class="col-xs-4 col-xs-offset-1">
          ...
          <input type="text" class="form-control" id="name" placeholder="Consumer Key" style="margin-bottom: 10px;">
          <label>Consumer Secret</label>
          <input type="text" class="form-control" id="name" placeholder="Consumer Secret" style="margin-bottom: 10px;">
          <label>Token</label>
          <input type="text" class="form-control" id="name" placeholder="Token" style="margin-bottom: 10px;">
          <label>Token Secret</label>
          <input type="text" class="form-control" id="name" placeholder="Token Secret" style="margin-bottom: 10px;">
          <label>Signature Method</label>
          <input type="text" class="form-control" id="name" placeholder="Signature Method" style="margin-bottom: 10px;">
          <label>Timestamp</label>
          <input type="text" class="form-control" id="name" placeholder="Timestamp" style="margin-bottom: 10px;">
          <label>Nonce</label>
          <input type="text" class="form-control" id="name" placeholder="Nonce" style="margin-bottom: 10px;">
          <label>Version</label>
          <input type="text" class="form-control" id="name" placeholder="Version" style="margin-bottom: 10px;">
          <label>Realm</label>
          <input type="text" class="form-control" id="name" placeholder="Opaque" style="margin-bottom: 10px;">
          <div class="row" style="margin-bottom: 10px;">
          	<div class="col-xs-6"><label>Add params to header</label></div>
          	<div class="col-xs-6">
          <input type="checkbox" name="" style="margin-left: 30px;">
      		</div>
          </div>
          <div class="row" style="margin-bottom: 10px;">
          	<div class="col-xs-6"><label>Auto add parameters</label></div>
          	<div class="col-xs-6">
          <input type="checkbox" name="" style="margin-left: 30px;">
      		</div>
          </div>
           <div class="row" style="margin-bottom: 10px;">
          	<div class="col-xs-6"><label>Keep empty parameters</label></div>
          	<div class="col-xs-6">
          <input type="checkbox" name="" style="margin-left: 30px;">
      		</div>
          </div>
